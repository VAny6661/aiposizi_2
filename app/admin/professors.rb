ActiveAdmin.register Professor, as: "Speaker" do
  ...
  #
  permit_params :image, :name, :position, :cabinet, :post_address, :email, :publications, :researches, :courses, :phone_number, documents: []
  #
  # or
  #
  # permit_params do
